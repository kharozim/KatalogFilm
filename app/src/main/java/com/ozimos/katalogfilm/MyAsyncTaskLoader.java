package com.ozimos.katalogfilm;
...
public class MyAsyncTaskLoader extends android.content.AsyncTaskLoader<ArrayList<WeatherItems>> {
    ...
    private static final String API_KEY = "12a0a4431f2f4f7bec6c2f09879be22f";
